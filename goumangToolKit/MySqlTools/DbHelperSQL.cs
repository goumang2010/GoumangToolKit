...
namespace GoumangToolKit
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        public static int ExecuteSqlTran(IEnumerable<string> SQLStringList)
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
              ...
              //  {
                    ...
                    {
                        string strsql = SQLStringList.ElementAt(n) ;
        ...
        {
            List<string> pickname = new List<string>();
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                DataSet ds = new DataSet();
                try
               ...
               dt= ds.Tables[0];
                ...
                {
                    pickname.Add(dt.Rows[i][0].ToString());

                }
            }
            return pickname;
        }
        public static Dictionary<string,string> getDic(string SQLString)
        {
            Dictionary<string, string> pickname = new Dictionary<string, string>();
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                DataSet ds = new DataSet();
                try
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    pickname.Add(dt.Rows[i][0].ToString(), dt.Rows[i][1].ToString());

                }
            }
            return pickname;
        }
        public static Dictionary<string, string> getDicOneRow(string SQLString)
        {
            Dictionary<string, string> pickname = new Dictionary<string, string>();
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                ...
                if (count>0)
                {
                    for (int i = 0; i < colCount; i++)
                    {
                        ...
                        pickname.Add(dt.Columns[i].ColumnName, dt.Rows[0][i].ToString());
        ...
        public static List<string> getlistcol(string SQLString)
        {
            List<string> pickname = new List<string>();
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
               ...
               dt= ds.Tables[0];
                ...
                for (int i = 0; i < count; i++)
                {
                    pickname.Add(dt.Rows[0][i].ToString());
